(() => {
    ...
    (() => {
        function t(t = location.host) {
            return -1 !== ["i18n.tradingview.com", "partial.tradingview.com", "www.tradingview.com", "wwwcn.tradingview.com"].indexOf(t) ||
                -1 !== ["d33t3vvu2t2yu5.cloudfront.net", "dwq4do82y8xi7.cloudfront.net", "s.tradingview.com", "s3.tradingview.com"].indexOf(t) ||
        ...
        new (class extends class {
            ...
            _replaceScript(t) {
                ...
                (this.hasCopyright = a || l),
                    ...
                    (o && this._isValidSettings()) || (console.error("Invalid settings provided, fall back to defaults"), (this.settings = this.filterRawSettings(this.defaultSettings)));
                ...
                if (
                    (m
                        ? (this.script.parentNode.replaceChild(this.iframe, m), this.script.parentNode.removeChild(this.script))
                        : d
            ...
            _iframeSrcBase(t, e) {
                ...
                return (
                    this.settings.useWidgetHost
                        ? (i = "https://www.tradingview-widget.com")
                        : "local" === e
                        ? (i = "http://" + t)
                        : "staging" === e && (i = -1 !== t.indexOf("beta.tradingview.com") ? "https://betacdn.tradingview.com" : "https://" + t),
            ...
            _buildGetQueryString() {
                ...
                return 0 === t.length
                    ...
                    : "?" +
                          (function (t) {
                              const e = [];
                              for (const i in t) t.hasOwnProperty(i) && null != t[i] && e.push({ key: i, pair: encodeURIComponent(i) + "=" + encodeURIComponent(t[i]) });
                              return e
            ...
            get propertiesToWorkWith() {
                return ["symbols", "linkPageTemplate", "largeChartUrl", "timeframe", "locale", "whitelabel", "customer", "colorTheme", "isTransparent", "showSymbolLogo", "useWidgetHost"];
            }
            filterRawSettings(t) {
                const e = super.filterRawSettings(t);
                return (e.width = "100%"), (e.height = this._calculateHeight(t.whitelabel)), e;
            }
            _calculateHeight(t) {
                let e = 0;
                const i = this.script.parentNode.querySelector(".tradingview-widget-copyright"),
